...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "Lq6Se575yGeYBsnmEHcmJCRfQ";       // Change this
	public static final String REST_CONSUMER_SECRET = "kh9tjyL3BhPrRT1MIKuKAIsCGJ3JXwv5iexZISL67MKEWxwn6Y"; // Change this
	...
	public void favTweet(String id, boolean fav, AsyncHttpResponseHandler handler) {
		String api_url;
		if(fav)
			api_url = getApiUrl("favorites/create.json");
		else
			api_url = getApiUrl("favorites/destroy.json");
	...
	public void getUserTimeline(String screenName,long totalItemsCount, AsyncHttpResponseHandler handler){
		String apiUrl = getApiUrl("statuses/user_timeline.json");
		RequestParams params = new RequestParams();
		params.put("count",totalItemsCount);
		params.put("screen_name",screenName);
